...
class _MatrimonyHomeScreenState extends State<MatrimonyHomeScreen> {
  ...
  Future<void> _fetchShortlistedProfiles() async {
    ...
    try {
      ...
      final url = Uri.parse('${ApiConfig.baseUrl}/likelist.php?user_id=$userId');
      final response = await http.get(url);
  ...
  Future<void> _fetchPremiumMembers() async {
    ...
    try {
      final url = Uri.parse('${ApiConfig.baseUrl}/premiuimmember.php?user_id=${userid}');
      final response = await http.get(url);
  ...
  Future<void> _fetchRecentMembers() async {
    ...
    try {
      ...
      final url = Uri.parse('${ApiConfig.baseUrl}/search_opposite_gender.php?user_id=$userid&sort_by=recent&limit=10');
      final response = await http.get(url);
  ...
  Future<void> _fetchOtherServices() async {
    ...
    try {
      final url = Uri.parse('${ApiConfig.baseUrl}/services_api.php');
      final response = await http.get(url);
                    ...
                    child: Container(
                      ...
                      child: ClipRRect(
                        ...
                        child: ProfileSwipeUI(
                          userId: userid,
                          matchApiUrl: '${ApiConfig.baseUrl}/match.php',
                          baseUrl: ApiConfig.baseUrl,
                          sendRequestApiUrl: '${ApiConfig.baseUrl}/send_request.php',
                          likeApiUrl: '${ApiConfig.baseUrl}/like_action.php',
                        ),
                      ),
                    ),
                  ),
            ...
            child: CircleAvatar(
              ...
              child: CircleAvatar(
                ...
                backgroundImage: userimage.isNotEmpty
                    ? NetworkImage('${ApiConfig.baseUrl}/$userimage')
                    : null,
