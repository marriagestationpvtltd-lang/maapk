...
class ProposalService {
  static const String baseUrl = "http://10.0.2.2/Api2/proposals_api.php";
  ...
  static Future<bool> deleteProposal(String userId, String proposalId) async {
    final response = await http.post(
      Uri.parse("http://10.0.2.2/Api2/purposal_delete.php"),
      body: {
        "user_id": userId,
  ...
  static Future<bool> acceptProposal(String proposalId, String userId) async {
    try {
      final response = await http.post(
        Uri.parse('http://10.0.2.2/Api2/acceptProposal.php'), // Update with your actual endpoint
        body: {
          'proposal_id': proposalId,
          'user_id': userId,
        },
  ...
  static Future<bool> rejectProposal(String proposalId, String userId) async {
    try {
      final response = await http.post(
        Uri.parse('http://10.0.2.2/Api2/rejectProposal.php'), // Update with your actual endpoint
        body: {
          'proposal_id': proposalId,
          'user_id': userId,
        },
