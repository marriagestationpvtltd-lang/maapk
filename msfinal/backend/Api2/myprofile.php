    ...
    $data = [
        ...
        "partner" => [
           ...
           // "maxweight" => $row['maxweight'],
            ...
            "mothertongue" => $row['partnerMotherTongue'], // Corrected field name
            "horoscopebelief" => $row['herscopeblief'], // Corrected field name
            ...
            "profession" => $row['partnerProfession'], // Corrected field name
